...
public class DataSourceMybatisDefaultConfig 
{
	...
	public TransactionInterceptor transactionInterceptor() throws Throwable
	{
		...
		prop.setProperty("sync*", "PROPAGATION_REQUIRED,-Exception");
		
		prop.setProperty("autoCancel", "PROPAGATION_REQUIRED,-Exception");
		prop.setProperty("cancel", "PROPAGATION_REQUIRED,-Exception");
