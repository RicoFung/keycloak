...
@Schema(description = "TbUserInfo0aGetOneRequest 详情入参")
public class TbUserInfo0aGetOneRequest implements Serializable
{
	...
	// 2.表单参数
	// ********************************************************************************************
	@Schema(title = "动态过滤", name="DynamicWhere(TbUserInfo0aGetOneRequest)", description="DynamicWhere(TbUserInfo0aGetOneRequest)")
	...
	public String toString()
	{
		return "TbUserInfo0aGetOneRequest [dynamicColumns=" + Arrays.toString(dynamicColumns) + ", dynamicWhere=" + dynamicWhere.toString() + "]";
	}
}
