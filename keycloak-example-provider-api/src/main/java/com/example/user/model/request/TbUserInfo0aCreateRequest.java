...
public class TbUserInfo0aCreateRequest implements Serializable
{
	...
	@Schema(title = "店仓是否按管理组可指令指向", example = "")
	@NotNull(message = "店仓是否按管理组可指令指向必传！")
	@NotBlank(message = "店仓是否按管理组可指令指向不能为空！")
	private java.lang.String tcIsUserGroupMapping0k;
    // 店仓是否按经营性质可指令指向       db_column: TC_IS_USER_METHOD_MAPPING_0K 
	@Schema(title = "店仓是否按经营性质可指令指向", example = "")
	@NotNull(message = "店仓是否按经营性质可指令指向必传！")
	@NotBlank(message = "店仓是否按经营性质可指令指向不能为空！")
	private java.lang.String tcIsUserMethodMapping0k;
    // 店仓是否按客户可指令指向       db_column: TC_IS_USER_CUSTOMER_MAPPING_0K 
	@Schema(title = "店仓是否按客户可指令指向", example = "")
	@NotNull(message = "店仓是否按客户可指令指向必传！")
	@NotBlank(message = "店仓是否按客户可指令指向不能为空！")
	private java.lang.String tcIsUserCustomerMapping0k;
    // 店仓是否按门店可指令指向       db_column: TC_IS_USER_STORE_MAPPING_0K 
	@Schema(title = "店仓是否按门店可指令指向", example = "")
	@NotNull(message = "店仓是否按门店可指令指向必传！")
	@NotBlank(message = "店仓是否按门店可指令指向不能为空！")
	private java.lang.String tcIsUserStoreMapping0k;
    // 店仓是否按国家可指令指向       db_column: TC_IS_USER_COUNTRY_MAPPING_0K 
	@Schema(title = "店仓是否按国家可指令指向", example = "")
	@NotNull(message = "店仓是否按国家可指令指向必传！")
	@NotBlank(message = "店仓是否按国家可指令指向不能为空！")
	private java.lang.String tcIsUserCountryMapping0k;
    // 店仓是否按经济区可指令指向       db_column: TC_IS_USER_REGION_MAPPING_0K 
	@Schema(title = "店仓是否按经济区可指令指向", example = "")
	@NotNull(message = "店仓是否按经济区可指令指向必传！")
	@NotBlank(message = "店仓是否按经济区可指令指向不能为空！")
	private java.lang.String tcIsUserRegionMapping0k;
    // 店仓是否按省份可指令指向       db_column: TC_IS_USER_PROVINCE_MAPPING_0K 
	@Schema(title = "店仓是否按省份可指令指向", example = "")
	@NotNull(message = "店仓是否按省份可指令指向必传！")
	@NotBlank(message = "店仓是否按省份可指令指向不能为空！")
	private java.lang.String tcIsUserProvinceMapping0k;
    // 店仓是否按城市可指令指向       db_column: TC_IS_USER_CITY_MAPPING_0K 
	@Schema(title = "店仓是否按城市可指令指向", example = "")
	@NotNull(message = "店仓是否按城市可指令指向必传！")
	@NotBlank(message = "店仓是否按城市可指令指向不能为空！")
	private java.lang.String tcIsUserCityMapping0k;
    // 店仓是否按物流中心可指令指向       db_column: TC_IS_USER_STORE_WW_MAPPING_0K 
	@Schema(title = "店仓是否按物流中心可指令指向", example = "")
	@NotNull(message = "店仓是否按物流中心可指令指向必传！")
	@NotBlank(message = "店仓是否按物流中心可指令指向不能为空！")
	private java.lang.String tcIsUserStoreWwMapping0k;
    // 店仓是否按管理团队可指令指向       db_column: TC_IS_USER_TEAM_MAPPING_0K 
	@Schema(title = "店仓是否按管理团队可指令指向", example = "")
	@NotNull(message = "店仓是否按管理团队可指令指向必传！")
	@NotBlank(message = "店仓是否按管理团队可指令指向不能为空！")
	private java.lang.String tcIsUserTeamMapping0k;
    // tcOldCode       db_column: TC_OLD_CODE 
	@Schema(title = "tcOldCode", example = "")
	@NotNull(message = "tcOldCode必传！")
	@NotBlank(message = "tcOldCode不能为空！")
