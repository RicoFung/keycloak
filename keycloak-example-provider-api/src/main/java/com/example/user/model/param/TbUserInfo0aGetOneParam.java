...
public class TbUserInfo0aGetOneParam implements Serializable
{
	...
	public String toString()
	{
		return "TbUserInfo0aGetOneParam [dynamicColumns=" + Arrays.toString(dynamicColumns) + ", dynamicWhere=" + dynamicWhere.toString() + "]";
	}
}
